...
import { Trophy, RefreshCw, Grid, Sparkles, Heart, Zap } from 'lucide-react';
      ...
      <div className="glass-card p-6 sm:p-8 rounded-3xl border-2 border-amber-400 shadow-2xl text-center space-y-6">
        ...
        <div className="grid grid-cols-3 gap-3">
          <div className="p-4 rounded-2xl bg-white border border-slate-200 shadow-sm">
            ...
            <div className="text-[11px] font-semibold text-slate-500 uppercase">Smashed</div>
          </div>

          <div className="p-4 rounded-2xl bg-white border border-slate-200 shadow-sm">
            <span className="text-lg block mb-1">🥮</span>
            <div className="text-2xl font-extrabold text-slate-900">{modaks}</div>
            <div className="text-[11px] font-semibold text-slate-500 uppercase">Modaks</div>
          </div>
        ...
        <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-3">
          <button
            onClick={onPlayAgain}
            className="w-full sm:w-auto px-8 py-3.5 rounded-full saffron-gradient-bg text-white font-extrabold text-base shadow-lg hover:scale-105 active:scale-95 transition-all flex items-center justify-center gap-2"
          >
